...
router.include_routers(text_message_router, forbidden_message_router, generation_router,
                       other_options_router, batch_size_router, picture_width_router, picture_height_router,
                       hr_fix_statement_router, back_to_options_router, choose_model_router, show_prompt_router)
